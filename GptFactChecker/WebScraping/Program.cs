...
namespace WebScraping
{
    ...
    {
        private const string ClimateArgumentDataJsonFilePath = @"C:\PrivateRepos\gpt-fact-checker\GptFactChecker\FactChecker\FactCheckers\ClimateStrategy\Data\climateArgumentData.json";
